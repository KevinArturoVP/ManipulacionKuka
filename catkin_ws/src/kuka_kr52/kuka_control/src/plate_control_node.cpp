#include <kuka_control/plate_control_node.hpp>

//using namespace Eigen;

//This code was based from CesMak kuka_arm at https://github.com/CesMak/kuka_arm
...
{
  ros::init(argc, argv, "kuka_control_node");
  ROS_INFO("*********** start kuka_control_node *************");
