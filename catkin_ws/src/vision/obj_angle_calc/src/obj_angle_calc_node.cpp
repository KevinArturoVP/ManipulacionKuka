		       ...
		       vision_msgs::DetectObjects::Response &resp)
{
	...
	threshold = 0.009;	// Distancia al plano en metros //Estaba originalmente en 0.009
	...
	// LLAMADA DE LA FUNCION PARA CALCULAR EL MEJOR PLANO
...
int main(int argc, char** argv)
{
	...
	ros::Publisher marker_pub;         // This is a publisher for Rviz Visualizator
        ...
        //Este servicio se ejecuta cuando hay un cliente (aquel en time_planes) y su función es mandar a llmar la función callbackPCAobject para 		calcular el plano y obtener el objeto detectado, así como obtener el centroide del objeto 
