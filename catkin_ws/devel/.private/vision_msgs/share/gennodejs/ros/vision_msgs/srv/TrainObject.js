...
class TrainObjectRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrainObjectRequest(null);
  ...
  static datatype() {
    ...
    return 'vision_msgs/TrainObjectRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrainObjectRequest(null);
...
class TrainObjectResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('trainObject')) {
        this.trainObject = initObj.trainObject
      }
      else {
        this.trainObject = new VisionObject();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [trainObject]
    bufferOffset = VisionObject.serialize(obj.trainObject, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrainObjectResponse(null);
    // Deserialize message field [trainObject]
    data.trainObject = VisionObject.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += VisionObject.getMessageSize(object.trainObject);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'vision_msgs/TrainObjectResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '63ff5e0065ed08101fba01779d6bd9a8';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrainObjectResponse(null);
    if (msg.trainObject !== undefined) {
      resolved.trainObject = VisionObject.Resolve(msg.trainObject)
    }
    else {
      resolved.trainObject = new VisionObject()
    }
...
module.exports = {
  ...
  md5sum() { return '57c41a970e8de200e42a2bb37474c896'; },
  datatype() { return 'vision_msgs/TrainObject'; }
};
