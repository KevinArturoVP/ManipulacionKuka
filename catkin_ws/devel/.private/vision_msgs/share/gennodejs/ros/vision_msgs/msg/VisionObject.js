...
class VisionObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('principal_axis')) {
        this.principal_axis = initObj.principal_axis
      }
      else {
        this.principal_axis = [];
      }
      if (initObj.hasOwnProperty('colors')) {
        ...
        this.colors = new geometry_msgs.msg.Vector3();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [principal_axis]
    // Serialize the length for message field [principal_axis]
    bufferOffset = _serializer.uint32(obj.principal_axis.length, buffer, bufferOffset);
    obj.principal_axis.forEach((val) => {
      bufferOffset = geometry_msgs.msg.Vector3.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [colors]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.colors, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [principal_axis]
    // Deserialize array length for message field [principal_axis]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.principal_axis = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.principal_axis[i] = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [colors]
    data.colors = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += 24 * object.principal_axis.length;
  ...
  static md5sum() {
    ...
    return 'cdf5b3f37fa74afd0c23f25f6c2bd349';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.principal_axis !== undefined) {
      resolved.principal_axis = new Array(msg.principal_axis.length);
      for (let i = 0; i < resolved.principal_axis.length; ++i) {
        resolved.principal_axis[i] = geometry_msgs.msg.Vector3.Resolve(msg.principal_axis[i]);
      }
    }
    else {
      resolved.principal_axis = []
    }

    if (msg.colors !== undefined) {
      resolved.colors = geometry_msgs.msg.Vector3.Resolve(msg.colors)
    }
    else {
      resolved.colors = new geometry_msgs.msg.Vector3()
    }
