...
bool operator==(const ::vision_msgs::RecognizeObjectResponse_<ContainerAllocator1> & lhs, const ::vision_msgs::RecognizeObjectResponse_<ContainerAllocator2> & rhs)
{
  return lhs.recog_object == rhs.recog_object;
}
...
struct MD5Sum< ::vision_msgs::RecognizeObjectResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x3c66aaede34c3430ULL;
  static const uint64_t static_value2 = 0x2d84aaa40a2377efULL;
};
