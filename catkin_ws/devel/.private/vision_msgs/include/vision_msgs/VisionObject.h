...
struct VisionObject_
{
  ...
  _pose_type pose;
   ...
   typedef std::vector< ::geometry_msgs::Vector3_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Vector3_<ContainerAllocator> >::other >  _principal_axis_type;
  _principal_axis_type principal_axis;

   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _colors_type;
  _colors_type colors;
...
bool operator==(const ::vision_msgs::VisionObject_<ContainerAllocator1> & lhs, const ::vision_msgs::VisionObject_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.size == rhs.size &&
    lhs.pose == rhs.pose &&
    lhs.principal_axis == rhs.principal_axis &&
    lhs.colors == rhs.colors &&
    lhs.bounding_box == rhs.bounding_box &&
    lhs.bounding_polygon == rhs.bounding_polygon &&
    lhs.x == rhs.x &&
    lhs.y == rhs.y &&
    lhs.width == rhs.width &&
    lhs.height == rhs.height &&
    lhs.graspable == rhs.graspable;
}
...
struct MD5Sum< ::vision_msgs::VisionObject_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xcdf5b3f37fa74afdULL;
  static const uint64_t static_value2 = 0x0c23f25f6c2bd349ULL;
};
...
struct Printer< ::vision_msgs::VisionObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vision_msgs::VisionObject_<ContainerAllocator>& v)
  {
    ...
    s << indent << "principal_axis[]" << std::endl;
    for (size_t i = 0; i < v.principal_axis.size(); ++i)
    {
      s << indent << "  principal_axis[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "    ", v.principal_axis[i]);
    }
    s << indent << "colors: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.colors);
