...
"""autogenerated by genpy from vision_msgs/RecognizeObjectsRequest.msg. Do not edit."""
import codecs
import sys
...
class RecognizeObjectsRequest(genpy.Message):
  _md5sum = "d8288ab03c94033ddae07988baace1f7"
  _type = "vision_msgs/RecognizeObjectsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecognizeObjectsRequest, self).__init__(*args, **kwds)
...
def _get_struct_IBI():
    ...
    return _struct_IBI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vision_msgs/RecognizeObjectsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class RecognizeObjectsResponse(genpy.Message):
  _md5sum = "5654a085f58967034a801978be85fbec"
  _type = "vision_msgs/RecognizeObjectsResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecognizeObjectsResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.recog_objects:
        ...
        length = len(val1.principal_axis)
        buff.write(_struct_I.pack(length))
        for val2 in val1.principal_axis:
          _x = val2
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v13 = val1.colors
        _x = _v13
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v19.is_dense,) = _get_struct_B().unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          val1.principal_axis.append(val2)
        _v26 = val1.colors
        _x = _v26
        start = end
        end += 24
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.recog_objects:
        ...
        _x = _v32
        buff.write(_get_struct_2I().pack(_x.height, _x.width))
        length = len(_v32.fields)
        buff.write(_struct_I.pack(length))
        for val3 in _v32.fields:
          _x = val3.name
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.offset, _x.datatype, _x.count,) = _get_struct_IBI().unpack(str[start:end])
          _v45.fields.append(val3)
        _x = _v45
        start = end
        end += 9
        (_x.is_bigendian, _x.point_step, _x.row_step,) = _get_struct_B2I().unpack(str[start:end])
        _v45.is_bigendian = bool(_v45.is_bigendian)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        (_v45.is_dense,) = _get_struct_B().unpack(str[start:end])
        _v45.is_dense = bool(_v45.is_dense)
        _v48 = val1.size
        _x = _v48
        start = end
        end += 24
...
def _get_struct_f():
    ...
    return _struct_f
class RecognizeObjects(object):
  _type          = 'vision_msgs/RecognizeObjects'
  _md5sum = '08b14f6fedb12138820b8355abbbced7'
  _request_class  = RecognizeObjectsRequest
  _response_class = RecognizeObjectsResponse
