...
"""autogenerated by genpy from vision_msgs/CubesSegmented.msg. Do not edit."""
import codecs
import sys
...
class CubesSegmented(genpy.Message):
  _md5sum = "2b935aade8f9275f5577fcbf7010f212"
  _type = "vision_msgs/CubesSegmented"
...
float64 z
"""
  __slots__ = ['header','recog_cubes']
  _slot_types = ['std_msgs/Header','vision_msgs/Cube[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CubesSegmented, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.recog_cubes is None:
        self.recog_cubes = []
    else:
      self.header = std_msgs.msg.Header()
      self.recog_cubes = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.recog_cubes)
      buff.write(_struct_I.pack(length))
      for val1 in self.recog_cubes:
        _x = val1.color
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
