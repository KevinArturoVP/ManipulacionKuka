...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.panoramic_cloud.is_dense
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.panoramic_image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.panoramic_image.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.panoramic_cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.faces.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
