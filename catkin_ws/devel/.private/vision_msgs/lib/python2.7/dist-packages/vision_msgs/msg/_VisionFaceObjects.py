...
"""autogenerated by genpy from vision_msgs/VisionFaceObjects.msg. Do not edit."""
import codecs
import sys
...
class VisionFaceObjects(genpy.Message):
  _md5sum = "4fd1cb6b6d63c7ee8d419e777e468fd2"
  _type = "vision_msgs/VisionFaceObjects"
...
float64 z
"""
  __slots__ = ['header','recog_faces']
  _slot_types = ['std_msgs/Header','vision_msgs/VisionFaceObject[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VisionFaceObjects, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.recog_faces is None:
        self.recog_faces = []
    else:
      self.header = std_msgs.msg.Header()
      self.recog_faces = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.recog_faces)
      buff.write(_struct_I.pack(length))
      for val1 in self.recog_faces:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
